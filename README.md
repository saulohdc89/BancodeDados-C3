...
Esse sistema de exemplo é composto por um conjunto de coleções(collections) que representam pedidos de locação, contendo coleções como: clientes, automóveis e locações.
